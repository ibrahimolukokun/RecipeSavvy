...
export function displayRecipes(meals) {
  ...
  meals.forEach(meal => {
    ...
    card.innerHTML = `
      <div class="recipe-image" style="background-image: url('${meal.strMealThumb}'); background-size: cover; background-position: center; height: 200px; position: relative;">
        <div class="recipe-review" style="position: absolute; background-color: rgba(31, 31, 31, 0.76); color: #fff; padding: 0.5rem 1rem; border-radius: 0 0.3rem 0rem 0.3rem; display: flex; align-items: center; gap: 0.5rem;">
          <i class="ri-star-fill" style="color: orange;"></i>
          <p style="margin: 0; font-weight: 600;">4.6</p>
        </div>
      </div>
